...
describe('collectionFactory', () => {
  it('should create a collection with expected interface methods', () => {
    ...
    expect(collection).toHaveProperty('remove');
    ...
    expect(collection).toHaveProperty('isSubset');
  });

  describe('instance', () => {
    const collection = collectionFactory<number>();
    ...
    it('should remove a value from a collection', () => {
      ...
      collection.add(2);
      expect(collection.has(1)).toEqual(true);
      expect(collection.remove(1)).toEqual(true);
  ...
  describe('advanced features', () => {
    const collection1 = collectionFactory();
    const collection2 = collectionFactory();
    const collection3 = collectionFactory();
