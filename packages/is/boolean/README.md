...
[![version](https://img.shields.io/npm/v/@zerodep/is-boolean?color=blue)](https://www.npmjs.com/package/@zerodep/is-boolean)
...
A simple, performant utility to determine if a value is a Boolean and assign a `boolean` Typescript type to the value.
...
isBoolean(new Date('1970-01-01T12:00:00.000Z')); // false
isBoolean(new Date('2099-12-31')); // false
...
isBoolean(gen1); // false
isBoolean(gen2); // false
...
// Promise
isBoolean(new Promise(() => 1)); // false
isBoolean(Promise.resolve()); // false

// Regular Expression
isBoolean(/[regx]+/gi); // false
