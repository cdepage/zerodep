...
For completeness, links to the @zerodep repositories with this nil:
...
- [@zerodep/is.nil](https://github.com/cdepage/zerodep/tree/main/packages/is.nil)

## How to Use

```typescript
import { isNil } from '@zerodep/utils';
// or
