...
A utility that determines if a value is an number.
...
For completeness, links to the @zerodep repositories with this number:
...
```typescript
import { isNumber } from '@zerodep/utils';
// or
...
- **minor versions**: includes addition of new numberality or backwards-compatible software improvements
...
- [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/is.number/CHANGELOG.md)
