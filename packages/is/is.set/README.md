...
A utility that determines if a value is a set.
...
For completeness, links to the @zerodep repositories with this set:
...
```typescript
import { isSet } from '@zerodep/utils';
// or
...
- **minor versions**: includes addition of new setality or backwards-compatible software improvements
