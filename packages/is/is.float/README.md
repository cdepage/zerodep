...
A utility that determines if a value is a float.
...
For completeness, links to the @zerodep repositories with this float:
...
```typescript
import { isFloat } from '@zerodep/utils';
// or
...
- **minor versions**: includes addition of new floatality or backwards-compatible software improvements
...
- [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/is.float/CHANGELOG.md)
