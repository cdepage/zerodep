...
describe('isTypedArray', () => {
  const exampleCases = [
    ...
    ['typedArray - sharedArrayBuffer', new SharedArrayBuffer(512), true],
  ...
  test.each(exampleCases)('should assess %s', async (title, value, result) => {
    console.log(title, Object.prototype.toString.call(value));
    expect(isTypedArray(value)).toEqual(result);
  });
});
