...
This package may be found on both [jsDelivr](https://cdn.jsdelivr.net/npm/@zerodep/is/umd.js) and [unpkg](https://unpkg.com/@zerodep/is/umd.js) in UMD, ESM and CJS formats.
