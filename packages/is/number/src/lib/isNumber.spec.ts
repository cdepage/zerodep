...
describe('isNumber', () => {
  const exampleCases = [
    ...
    ['float - -0.0', -0.0, true],
    ['float - -3.14', -3.14, true],
    ['float - Math.E', Math.E, true],
    ['float - Math.PI', Math.PI, true],
    ['float - min value', Number.MIN_VALUE, true],
    ...
    ['number - max safe int', Number.MAX_SAFE_INTEGER, true],
    ['number - max value', Number.MAX_VALUE, true],
    ['number - 3e8', 3e8, true],
    ['number - 42', 42, true],
    ['number - 1', 1, true],
    ['number - 0', 0, true],
    ...
    ['number - -42', -42, true],
    ['number - -3e8', -3e8, true],
    ['number - min safe int', Number.MIN_SAFE_INTEGER, true],
