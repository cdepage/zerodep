...
A utility that determines if a value is an integer.
...
For completeness, links to the @zerodep repositories with this integer:
...
```typescript
import { isInteger } from '@zerodep/utils';
// or
...
isFloat(3.14); // false
isInteger(100n); // false
isInteger('2022-04-15'); // false
...
- **minor versions**: includes addition of new integerality or backwards-compatible software improvements
...
- [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/is.integer/CHANGELOG.md)
