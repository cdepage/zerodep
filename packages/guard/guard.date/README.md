...
[![minified size](https://img.shields.io/bundlephobia/min/@zerodep/guard.date?style=flat-square&color=blue)](https://bundlephobia.com/package/@zerodep/guard.date) [![minified+gzipped size](https://img.shields.io/bundlephobia/minzip/@zerodep/guard.date?style=flat-square&color=blue)](https://bundlephobia.com/package/@zerodep/guard.date) [![tree shaking](https://img.shields.io/badge/tree%20shaking-supported-blue?style=flat-square)](https://bundlephobia.com/package/@zerodep/guard.date) ![language](https://img.shields.io/github/languages/top/cdepage/zerodep?style=flat-square) ![types](https://badgen.net/npm/types/@zerodep/guard.date?style=flat-square)

![coverage](https://img.shields.io/badge/coverage-100%25-green?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/cdepage/zerodep?style=flat-square) ![vulnerabilities](https://img.shields.io/snyk/vulnerabilities/npm/@zerodep/guard.date?style=flat-square)

[![app](https://img.shields.io/badge/app-%40zerodep-orange?style=flat-square)](https://www.npmjs.com/package/@zerodep/app) [![version](https://img.shields.io/npm/v/@zerodep/guard.date?style=flat-square&color=orange)](https://www.npmjs.com/package/@zerodep/guard.date)
...
guardDate('1999-12-31'); // throws ZeroDepErrorGuard
```
...
const guardDate = guardDateHOF(options);

guardDate(new Date('2022-02-24')); // void
guardDate('1999-12-31'); // throws ZeroDepErrorGuardType
guardDate(new Date('1812-06-18')); // throws ZeroDepErrorGuardRange
guardDate(new Date('2161-10-11')); // throws ZeroDepErrorGuardRange
```
...
<!-- for ES Modules (ESM) -->
<script type="module">
  import { guardDate } from 'https://cdn.jsdelivr.net/npm/@zerodep/guard.date/esm.js';
  // ...your code here
</script>
...
<script src="https://cdn.jsdelivr.net/npm/@zerodep/guard.date/umd.js"></script>
<script>
  // example of "zd" prefix
  const result = zd.guardDate(new Date());
</script>
```

This package may be found on both [jsDelivr](https://cdn.jsdelivr.net/npm/@zerodep/guard.date/umd.js) and [unpkg](https://unpkg.com/@zerodep/guard.date/umd.js) in UMD, ESM and CJS formats.
...
declare const guardDate: (value: any | any[]) => void;

// customizing the configuration options
declare const guardDateHOF: (options?: GuardDateOptions) => (value: any | any[]) => void;
...
- If set, and the value is earlier than this date, a ZeroDepErrorGuardRange error will be thrown

**latest:**

- Defaults to: undefined
- If set, and the value is later than this date, a ZeroDepErrorGuardRange error will be thrown

### Examples

All examples assume ESM or CJS packages. If using a UMD package remember to prefix with the **zd** namespace, e.g. `zd.guardDate(...)`.
...
guardDate(new Date('1945-05-09')); // void
guardDate('not a date'); // throws a ZeroDepErrorGuardType
```
...
guardDate(new Date('2022-04-27')); // Date('2022-04-27')
guardDate('not a date'); // throws a ZeroDepErrorGuardType
guardDate(new Date('1812-06-18')); // throws ZeroDepErrorGuardRange
guardDate(new Date('2161-10-11')); // throws ZeroDepErrorGuardRange
```
