...
A utility that determines if a value is an array.
...
```typescript
import { isArray } from '@zerodep/utils';
// or
...
- [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/is.array/CHANGELOG.md)
