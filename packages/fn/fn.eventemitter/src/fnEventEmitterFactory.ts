/* eslint-disable prefer-rest-params, @typescript-eslint/no-non-null-assertion */
...
export interface FnEventEmitter<T extends EventMap> {
...
export const fnEventEmitterFactory = <T extends EventMap>(): FnEventEmitter<T> => {
  let events: {
