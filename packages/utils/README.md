...
This is a barrel-package of all available utilities in the @zerodep ecosystem.
...
This package is available from one tree shakeable npm package:
...
| Utility | Purpose |
| --- | --- |
| [Errors](https://github.com/cdepage/zerodep/tree/main/packages/errors) | The ZeroDepError object that all @zerodep packages use and extend |
| [Guards](https://github.com/cdepage/zerodep/tree/main/packages/guards) | Ensure function-level arguments are of the correct shape |
...
- [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/utils/CHANGELOG.md)
