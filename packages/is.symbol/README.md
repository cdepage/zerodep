...
A utility that determines if a value is a symbol.
...
For completeness, links to the @zerodep repositories with this symbol:
...
- **minor versions**: includes addition of new symbolality or backwards-compatible software improvements
