...
[![minified size](https://img.shields.io/bundlephobia/min/@zerodep/can.iterate?style=flat-square&color=blue)](https://bundlephobia.com/package/@zerodep/can.iterate) [![minified+gzipped size](https://img.shields.io/bundlephobia/minzip/@zerodep/can.iterate?style=flat-square&color=blue)](https://bundlephobia.com/package/@zerodep/can.iterate) [![tree shaking](https://img.shields.io/badge/tree%20shaking-supported-blue?style=flat-square)](https://bundlephobia.com/package/@zerodep/can.iterate) ![language](https://img.shields.io/github/languages/top/cdepage/zerodep?style=flat-square) ![types](https://badgen.net/npm/types/@zerodep/can.iterate?style=flat-square)

![coverage](https://img.shields.io/badge/coverage-100%25-green?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/cdepage/zerodep?style=flat-square) ![vulnerabilities](https://img.shields.io/snyk/vulnerabilities/npm/@zerodep/can.iterate?style=flat-square)

[![app](https://img.shields.io/badge/app-%40zerodep-orange?style=flat-square)](https://www.npmjs.com/package/@zerodep/app) [![version](https://img.shields.io/npm/v/@zerodep/can.iterate?style=flat-square&color=orange)](https://www.npmjs.com/package/@zerodep/can.iterate)
...
This package may be found on both [jsDelivr](https://cdn.jsdelivr.net/npm/@zerodep/can.iterate/umd.js) and [unpkg](https://unpkg.com/@zerodep/can.iterate/umd.js) in UMD, ESM and CJS formats.
