...
A utility that determines if a value is a weakset.
...
For completeness, links to the @zerodep repositories with this weakset:
...
```typescript
import { isWeakset } from '@zerodep/utils';
// or
