...
// or
import { guardObject } from '@zerodep/guards.object';
...
// or
import { IGuardObjectOptions, guardObject } from '@zerodep/guards';
// or
import { IGuardObjectOptions, guardObject } from '@zerodep/guards.object';
...
The above said, a security best practice is to pin your software packages to specific versions and only upgrade to more recent releases after careful inspection of both the [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/guards.object/CHANGELOG.md) and any associated software changes.

## Resources

- [Security Policy](https://github.com/cdepage/zerodep/blob/main/SECURITY.md)
- [Changelog](https://github.com/cdepage/zerodep/blob/main/packages/guards.object/CHANGELOG.md)
